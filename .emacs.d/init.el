...
(use-package emacs
  ...
  :config
  (defvar daut/default-font-family "JetBrainsMono Nerd Font")
...
(use-package nerd-icons
  :custom
  ;; "Symbols Nerd Font Mono" isn't installed on Omarchy; the JetBrains Mono
  ;; NF variant (the default font) carries the same PUA glyphs.
